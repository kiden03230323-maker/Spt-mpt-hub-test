...
-- ============================================
-- PRO CONFIGS TAB (Premium/Whitelisted)
-- ============================================
local ProTab = Window:CreateTab("Pro Configs", false, true) -- true = premium/whitelisted
local ProPage = ProTab:CreatePage("Page 1")
local ProCard = ProPage:CreateSection("Pro Capabilities")
...
ProCard:AddButton("Execute Example Script", function() print("Executing Script...") end, {
    ...
    Example = "Clicking this instantly runs the preset custom script block below."
})
